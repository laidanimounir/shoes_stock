...
class _AchatFournisseurScreenState extends State<AchatFournisseurScreen> {
 ...
 Column(children: [
 Text('Ancien prix',
 style: AppTextStyles.bodyMedium(color: Color(0xFF6B7C93))),
 ...
 style: AppTextStyles.bodyMedium(color: isHigher ? const Color(0xFFE67E22) : const Color(0xFF2ECC71))),
 ]),
 Container(
 ...
 child: Text('Annuler', style: AppTextStyles.bodyMedium(color: Color(0xFF6B7C93))),
 ),
 ],
 ),
 );
 ...
 children: [
 Text(S.t('buy_total_invoice'), style: const TextStyle()),
 Text('${totalAmount.toStringAsFixed(2)} ${S.t('misc_currency')}', style: const TextStyle(color: Colors.deepPurple)),
 ],
 ),
 ),
 ...
 style: AppTextStyles.bodyMedium( color: const Color(0xFF1B4F72))),
 ...
 style: AppTextStyles.bodyMedium(color: Color(0xFF2ECC71))),
 ]),
 );
 }
 final isHigher = diff > 0;
 ...
 style: AppTextStyles.bodyMedium(color: isHigher ? const Color(0xFFE67E22) : const Color(0xFF1B4F72))),
 ),
 ]),
 );
 }
 ...
 style: AppTextStyles.bodyMedium(color: Color(0xFF6B7C93))),
 const Spacer(),
 Text('$qty pcs', style: AppTextStyles.bodyMedium()),
 const SizedBox(width: 16),
 Text('$price DA',
 style: AppTextStyles.bodyMedium(color: Color(0xFF1B4F72))),
 ]),
 );
 }),
 ],
 ...
 style: AppTextStyles.bodyMedium( color: const Color(0xFF1A2533)),
 ),
 const SizedBox(height: 8),
 Text(
 _errorMessage,
 ...
 style: AppTextStyles.bodyMedium(color: const Color(0xFF2ECC71))),
 ),
 ],
 ),
 ...
 style: AppTextStyles.bodyMedium( color: kPrimary)),
 IconButton(
 ...
 children: [
 Text('Total commande:',
 style: AppTextStyles.bodyMedium(color: Color(0xFF111827))),
 Text(
