...
void _syncMetadataSerialize(
  ...
  writer.writeLong(offsets[2], object.pendingCount);
}
...
SyncMetadata _syncMetadataDeserialize(
  ...
  object.pendingCount = reader.readLong(offsets[2]);
  return object;
}
...
extension SyncMetadataQueryWhereSort
  ...
  QueryBuilder<SyncMetadata, SyncMetadata, QAfterWhere> anyIsarId() {
...
extension SyncMetadataQueryWhere
  ...
  QueryBuilder<SyncMetadata, SyncMetadata, QAfterWhereClause> isarIdEqualTo(
      Id isarId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncMetadata, SyncMetadata, QAfterWhereClause> isarIdNotEqualTo(
      Id isarId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncMetadata, SyncMetadata, QAfterWhereClause> isarIdGreaterThan(
      Id isarId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncMetadata, SyncMetadata, QAfterWhereClause> isarIdLessThan(
      Id isarId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<SyncMetadata, SyncMetadata, QAfterWhereClause> isarIdBetween(
    Id lowerIsarId,
    Id upperIsarId, {
...
extension SyncMetadataQueryFilter
  ...
  QueryBuilder<SyncMetadata, SyncMetadata, QAfterFilterCondition> isarIdEqualTo(
      Id value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncMetadata, SyncMetadata, QAfterFilterCondition> isarIdBetween(
    Id lower,
    Id upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<SyncMetadata, SyncMetadata, QAfterFilterCondition> modeEqualTo(
    String value, {
  ...
  QueryBuilder<SyncMetadata, SyncMetadata, QAfterFilterCondition> modeLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<SyncMetadata, SyncMetadata, QAfterFilterCondition> modeBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<SyncMetadata, SyncMetadata, QAfterFilterCondition> modeEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncMetadata, SyncMetadata, QAfterFilterCondition> modeContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncMetadata, SyncMetadata, QAfterFilterCondition> modeMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension SyncMetadataQuerySortBy
  ...
  QueryBuilder<SyncMetadata, SyncMetadata, QAfterSortBy> sortByMode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'mode', Sort.asc);
    });
  }

  QueryBuilder<SyncMetadata, SyncMetadata, QAfterSortBy> sortByModeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SyncMetadataQuerySortThenBy
  ...
  QueryBuilder<SyncMetadata, SyncMetadata, QAfterSortBy> thenByIsarId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isarId', Sort.asc);
    });
  }

  QueryBuilder<SyncMetadata, SyncMetadata, QAfterSortBy> thenByIsarIdDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncMetadata, SyncMetadata, QAfterSortBy> thenByMode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'mode', Sort.asc);
    });
  }

  QueryBuilder<SyncMetadata, SyncMetadata, QAfterSortBy> thenByModeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'mode', Sort.desc);
    });
  }
...
extension SyncMetadataQueryWhereDistinct
  ...
  QueryBuilder<SyncMetadata, SyncMetadata, QDistinct> distinctByMode(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension SyncMetadataQueryProperty
  ...
  QueryBuilder<SyncMetadata, int, QQueryOperations> isarIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncMetadata, String, QQueryOperations> modeProperty() {
    return QueryBuilder.apply(this, (query) {
